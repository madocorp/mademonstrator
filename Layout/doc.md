...
You can change the bullet points to an image. 
...
It will affect only the bullet points
* on the current slide
* after the definition

Images are displayed in their original size and positioned inline by default. You can ![:inline:32x32+0+0](Layout/mademo.png) overwrite this.
One of the dimension can be @ to keep the aspect ratio.

```
![:absolute:20%x20%-0-0](Layout/mademo.png)
![:inline:10x@+0+0](Layout/mademo.png)
```
